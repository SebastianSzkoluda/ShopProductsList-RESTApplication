...
import static com.sszkoluda.shopproductslist.model.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.sszkoluda.shopproductslist.model.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(FamilyUser user) {
        ...
        claims.put("avatar",user.getAvatarFilename() != null ? user.getAvatarFilename() : "");
        return Jwts.builder()
                .setClaims(claims)
